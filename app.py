...
df= pd.read_excel(r'F:\Python Scripts\VizWhiz\NHL\NHL2019Data.xlsx', sheet_name = 'Sheet8')
...
#    dff = df[df['Year'] == year_value]
    ...
    traces = []
    for i in dff.Playoffs.unique():
        dff2 = dff[dff['Playoffs'] == i]
        traces.append(go.Scatter3d(
            ...
            text=dff2[dff2['Indicator Name'] == yaxis_column_name]['Team'],
            customdata=dff2[dff2['Indicator Name'] == yaxis_column_name]['Team'],
            mode='markers',
            opacity=0.9,
            marker={
                'size': 10,
